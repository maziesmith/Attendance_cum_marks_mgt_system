                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					<center>
						...
						<form class="form-inline" method="POST" action="2bea.php">
							<table class="table">
								<tr>
                  <th>From Date: </th>
                  <td><input type="date" name="FromDate" style="width: 250px"></td>
								</tr>
                <tr>
                  <th>To Date: </th>
                  <td><input type="date" name="ToDate" style="width: 250px"></td>
                </tr>
                <tr>
                  <th>Subject: </th>
									<td>
                  <div class="form-group">
                  <select class="form-control" name="sub_id" style="width: 250px">
