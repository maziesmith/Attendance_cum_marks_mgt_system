          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Previous Records > View Defaulters</h2>
                ...
                $ssql = "select distinct Enrollment_No from final_attendance order by Dates desc ";
                  ...
                  $sssql = "select a.Name, a.Present_days, a.Total_days, a.Percentage from final_attendance as a LEFT OUTER JOIN final_attendance as b ON a.Enrollment_No = b.Enrollment_No AND a.Dates < b.Dates WHERE b.Enrollment_No IS NULL AND a.Branch='$branch' AND a.Sem='$sem' AND a.Enrollment_No=$valu limit 1";
