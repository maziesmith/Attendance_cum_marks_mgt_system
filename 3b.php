...
$sql=mysqli_query($db,"select sub_1,sub_2,sub_3,sub_4 from lecture_subject where branch='CSE' ");
$coun=0;
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
					<center>
						...
						<form class="form-vertical" role="form" method="POST" action="3ba.php">
							<table class="table">
                <tr>
                  <th>Date: </th>
                ...
                <tr>
                  <th>Enrollment No: </th>
                  <td><input type="text" style="width: 300px;" name="rollno"></td>
                </tr>      
