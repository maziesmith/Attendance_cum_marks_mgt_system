        ...
        <div class="right_col" role="main">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <form class="form-vertical" role="form" method="POST" action="2bca.php">
                    <table class="table">
                <tr>
          ...
          <table class="table table-striped jambo_table">
            ...
            <tbody>
                ...
                $ssql = "select Enrollment_No, Name, Attendance from final_attendance where Dates='$date' AND Branch='$branch' AND Sem='$sem' AND Enrollment_No='$rollno' ";
                  ...
                  echo '<td><input type="text" style="width: 120px" name="name'.$id.'" value="'.$row["Name"].'" readonly></td>';
                  echo '<td><input type="text" style="width: 30px; text-align: center;" name="Attendance'.$id.'" value="'.$Attendance.'" readonly></td>';

                  $sssql = "select a.Present_days, a.Total_days, a.Percentage from final_attendance as a LEFT OUTER JOIN final_attendance as b ON a.Enrollment_No = b.Enrollment_No AND a.Dates < b.Dates WHERE b.Enrollment_No IS NULL AND a.Enrollment_No=$valu limit 1";
                  ...
                  echo '<td><input type="text" style="width: 30px; text-align: center;" name="Present" value="'.$Present_days.'" readonly></td>';  
                  echo '<td><input type="text" style="width: 30px; text-align: center;" name="Total" value="'.$Total_days.'" readonly></td>';
                  echo '<td><input type="text" style="width: 50px; text-align: center;" name="Percentage" value="'.$Percentage.'" readonly></td>';
                  echo "</tr>";
                  }
              ...
              <br><div class="alignment">
                ...
                <input type="button" onclick="window.location='Professor_home.php'" class="btn btn-default btn-lg" value="Back">
                </div>  
                <input type="hidden" value="<?php echo $sub; ?>" name="sub">
                <input type="hidden" value="<?php echo $date; ?>" name="date">
                <input type="hidden" value="<?php echo $valu; ?>" name="rollno">
                <input type="hidden" value="<?php echo $Attendance; ?>" name="attendance">
              </form>
