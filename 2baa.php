          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Previous Records > View Subject Attendance</h2>
                ...
                $ssql = "select Enrollment_No, Name, Attendance from final_attendance where Dates='$date' AND Branch='$branch' AND Sem='$sem' ";
                  ...
                  $sssql = "select a.Present_days, a.Total_days from final_attendance as a LEFT OUTER JOIN final_attendance as b ON a.Enrollment_No = b.Enrollment_No AND a.Dates < b.Dates WHERE b.Enrollment_No IS NULL AND a.Enrollment_No=$valu limit 1";
