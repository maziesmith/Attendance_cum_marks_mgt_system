          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Previous Records > View Student Attendance</h2>
                ...
                $ssql = "select Enrollment_No, Name, Attendance from final_attendance where Dates='$date' AND Branch='$branch' AND Sem='$sem' AND Enrollment_No='$rollno' ";
                  ...
                  echo '<td><input type="text" style="width: 30px; text-align: center; background:'.$colorz.'; color:'.$colorzz.';" name:"Attendance'.$id.'"; value="'.$Attendance.'" readonly></td>';
                  ...
                  echo '<td><input type="text" style="width: 50px; text-align: center;" name="Percentage'.$id.'" value="'.$Percentage.'" readonly></td>';
                  echo "</tr>";
                  }
